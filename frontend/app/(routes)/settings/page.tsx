  ...
  return (
    <div className="flex-1 bg-linear-to-b from-background to-muted/20">
      ...
      <main className="container mx-auto px-4 py-6 sm:px-6 lg:px-8 space-y-6">
        ...
        <Card className="border-red-300/60 bg-red-500/5">
          <CardHeader>
          ...
          <CardContent className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <p className="text-sm text-muted-foreground">
              All your workflows, credentials, chat sessions, and related data
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This is permanent. All data tied to your account will be lost,
              including workflows, credentials, and chat history.
            </DialogDescription>
          </DialogHeader>
