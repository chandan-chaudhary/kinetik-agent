  ...
  return (
    <>
      ...
      >
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="mb-4">
              <h3 className="text-lg font-semibold">Asset data API Configuration</h3>
              <p className="text-sm text-muted-foreground">
                Select API provider and provide credentials to fetch live market data
              </p>
            </div>
      ...
      <BaseActionNode
        ...
        id={props.id}
        name="Asset Data"
        description="Fetch asset data from API"
        icon={Database}
        status={status}
